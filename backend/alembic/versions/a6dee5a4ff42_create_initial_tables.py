...
def upgrade() -> None:
    ...
    op.create_foreign_key("fk_pages_current_revision_id", "pages", "page_revisions", ["current_revision_id"], ["id"], ondelete="SET NULL")
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_pages_current_revision_id')
